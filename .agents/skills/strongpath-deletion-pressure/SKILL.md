---
name: strongpath-deletion-pressure
description: Use when reviewing StrongPath governance, workflows, prompts, checklists, backlog items, operating processes, or any process-like document where deletion, compression, or add-back discipline may improve execution speed, quality, regression control, reviewability, or decision quality.
---

# StrongPath Deletion Pressure
...
- Name the risk of deleting too much.
...
RISK OF OVER-DELETION
BEST-IN-CLASS COMPARISON
REVISED OPERATING VERSION
NEXT ACTION
```
